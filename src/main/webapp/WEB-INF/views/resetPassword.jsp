	...
	<div class="row justify-content-center">
		<div class="col-md-5">
			<div class="card">
				...
				<div class="card-body">
					<h6 align="center" style="color:red"><c:out value="${error}"/></h6>
					<form class="form-horizontal" action="/email/reset" method="post">
...
<%--						</div>--%>
						<div class="form-group " align="center">
							...
							<div align="right"><a href="/user/login" title="Back"><i class="fa fa-arrow-circle-left" aria-hidden="true" style="font-size:25px"></i></a></div></div>
					</form>
				</div>
			</div>
		</div>

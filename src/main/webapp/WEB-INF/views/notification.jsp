    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="/librarian/notificationAdd" method="post">
                        ...
                        <div class="form-group row=1" align="center">
                            ...
                            <div class="form-group" align="right">
                                <a href="/librarian/viewBook" title="Back"><i class="fa fa-arrow-circle-left" aria-hidden="true" style="font-size:25px"></i></a>
                            </div>
                        </div>
                    </form>
                </div>

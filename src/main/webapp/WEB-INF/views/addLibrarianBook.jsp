    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="/librarian/addOrUpdateBook" method="post" enctype="multipart/form-data">
                        ...
                        <c:if test="${book.id == null}">
                            <div class="form-group " align="center" class="row">
                                ...
                                <div class="form-group " align="right">
                                    <a href="/librarian/viewBook" title="Back"><i class="fa fa-arrow-circle-left" aria-hidden="true" style="font-size:23px"></i></a>
                                </div>
                            </div>
                        </c:if>
                        <c:if test="${book.id!= null}">
